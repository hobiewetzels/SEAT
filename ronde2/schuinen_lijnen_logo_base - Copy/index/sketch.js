...
for (i = 1; i < numbSq; i++) {
  ...
  if ( isOdd(i) == 1 ){
    var width = 700 + Math.floor(Math.random() * 100);
    var width2 = 1100 + Math.floor(Math.random() * 100);
  }else{
    var width2 = 700 + Math.floor(Math.random() * 100);
    var width = 1100 + Math.floor(Math.random() * 100);
  }
  squares.push({
    //left under
